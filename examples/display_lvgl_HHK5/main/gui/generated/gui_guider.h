...
typedef struct
{
	...
	lv_obj_t *screen_notif_label_var1_tex;
	lv_obj_t *screen_notif_img_notif_type;
	lv_obj_t *screen_notif_img_back;
	lv_obj_t *screen_notif_cont_labels;
	...
	lv_obj_t *screen_network_label_tips;
	lv_obj_t *screen_network_qrcode_url;
	lv_obj_t *screen_speedtest;
	bool screen_speedtest_del;
	lv_obj_t *screen_speedtest_label_ssid_title;
	lv_obj_t *screen_speedtest_label_var1_tex;
	...
	lv_obj_t *screen_select_btn_yes;
	lv_obj_t *screen_select_btn_yes_label;
