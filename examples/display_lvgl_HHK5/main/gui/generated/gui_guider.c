...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_main_loop_del = true;
    ui->screen_bu0_del = true;
    ui->screen_bu1_del = true;
    ui->screen_bu2_del = true;
    ui->screen_bu3_del = true;
    ui->screen_STB1_del = true;
    ui->screen_notif_del = true;
    ui->screen_network_del = true;
    ui->screen_speedtest_del = true;
