...
void setup_scr_screen_network(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->screen_network_label_ssid_title, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_network_cont_title, 2, 0);
    lv_obj_set_size(ui->screen_network_cont_title, 960, 113);
    ...
    lv_obj_set_pos(ui->screen_network_label_title, 30, 17);
    lv_obj_set_size(ui->screen_network_label_title, 372, 43);
    ...
    lv_obj_set_style_text_font(ui->screen_network_label_title, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_network_line_2, 37, 69);
    ...
    lv_obj_set_pos(ui->screen_network_btn_back, 684, 26);
    lv_obj_set_size(ui->screen_network_btn_back, 230, 26);
    ...
    lv_obj_set_style_text_font(ui->screen_network_btn_back, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_network_label_ssid, 60, 181);
    ...
    lv_obj_set_style_text_font(ui->screen_network_label_ssid, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_network_label_passwd_title, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_network_label_passwd, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_network_label_qrcode, 568, 241);
    lv_obj_set_size(ui->screen_network_label_qrcode, 147, 94);
    ...
    lv_obj_set_style_text_font(ui->screen_network_label_qrcode, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_network_qrcode_wifi, 754, 113);
