...
void setup_scr_screen_notif(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_notif_cont_title, 960, 113);
    ...
    lv_obj_set_pos(ui->screen_notif_label_title, 30, 17);
    lv_obj_set_size(ui->screen_notif_label_title, 372, 43);
    ...
    lv_obj_set_style_text_font(ui->screen_notif_label_title, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_notif_line_1
    ui->screen_notif_line_1 = lv_line_create(ui->screen_notif_cont_title);
    lv_obj_set_pos(ui->screen_notif_line_1, 37, 69);
    lv_obj_set_size(ui->screen_notif_line_1, 864, 5);
    static lv_point_precise_t screen_notif_line_1[] = {{0, 0},{900, 0}};
    lv_line_set_points(ui->screen_notif_line_1, screen_notif_line_1, 2);

    //Write style for screen_notif_line_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_line_width(ui->screen_notif_line_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_line_color(ui->screen_notif_line_1, lv_color_hex(0x757575), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_line_opa(ui->screen_notif_line_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_line_rounded(ui->screen_notif_line_1, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_notif_btn_back
    ui->screen_notif_btn_back = lv_button_create(ui->screen_notif_cont_title);
    lv_obj_set_pos(ui->screen_notif_btn_back, 684, 26);
    lv_obj_set_size(ui->screen_notif_btn_back, 230, 26);
    ui->screen_notif_btn_back_label = lv_label_create(ui->screen_notif_btn_back);
    lv_label_set_text(ui->screen_notif_btn_back_label, "Back to menu\n");
    lv_label_set_long_mode(ui->screen_notif_btn_back_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_notif_btn_back_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_notif_btn_back, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_notif_btn_back_label, LV_PCT(100));

    //Write style for screen_notif_btn_back, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_notif_btn_back, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_notif_btn_back, lv_color_hex(0x004D8F), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_notif_btn_back, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_notif_btn_back, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_notif_btn_back, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_notif_btn_back, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_notif_btn_back, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_notif_btn_back, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_notif_btn_back, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_notif_btn_back, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
