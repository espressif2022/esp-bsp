...
function(spiffs_create_partition_assets partition base_dir)
    ...
    if("${size}" AND "${offset}")
        ...
        set(combined_file ${CMAKE_BINARY_DIR}/mmap_build/${base_dir_name}/combined.bin)
        ...
        message(STATUS "app_bin_path: ${app_bin_path}")
        ...
        if(arg_FLASH_IN_PROJECT)
            ...
            add_dependencies(app-flash spiffs_${partition}_bin)
        endif()
    else()
