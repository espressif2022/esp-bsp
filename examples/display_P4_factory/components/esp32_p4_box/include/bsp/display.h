...
#define BSP_LCD_MIPI_DSI_LCD_HBP                (10)
#define BSP_LCD_MIPI_DSI_LCD_HFP                (20)
#define BSP_LCD_MIPI_DSI_LCD_VSYNC              (10)
#define BSP_LCD_MIPI_DSI_LCD_VBP                (16)
#define BSP_LCD_MIPI_DSI_LCD_VFP                (10)

#define BSP_LCD_MIPI_DSI_LANE_NUM               (2)     // 2 data lanes
#define BSP_LCD_MIPI_DSI_LANE_BITRATE_MBPS      (400)   // 1Gbps
