...
#define TEST_LCD_IO_SPI_SCK_WITHOUT_MULTIPLEX   (GPIO_NUM_8)
#define TEST_LCD_IO_SPI_SCK_WITH_MULTIPLEX      (TEST_LCD_IO_RGB_DATA14)
#define TEST_LCD_IO_SPI_SDA_WITHOUT_MULTIPLEX   (GPIO_NUM_18)
...
static void test_init_lcd(bool use_io_expander, bool use_io_multiplex)
{
    ...
    if (use_io_expander) {
        ...
        spi_line_config_t line_config = {
            ...
            .cs_expander_pin = TEST_LCD_IO_SPI_CS_EXPANDER,
            .scl_io_type = IO_TYPE_GPIO,
            .scl_gpio_num = TEST_LCD_IO_SPI_SCK_WITH_MULTIPLEX,
            .sda_io_type = IO_TYPE_GPIO,
            .sda_gpio_num = TEST_LCD_IO_SPI_SDA_WITH_MULTIPLEX,
    ...
    if (use_io_multiplex) {
        vendor_config.flags.enable_io_multiplex = 1;
    } else {
